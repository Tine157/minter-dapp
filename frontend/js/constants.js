const contractAddress = "0x6D0F5598CE8997cDB19FC8C1DB7f1e6E9b1c576A"; //Replace with your own contract address
const chain = 'rinkeby'; // rinkeby or polygon

const welcome_h1 = "Welcome to the Street Perro!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'Street Perro is a decentralized proyect with the goal to use part of its earnings in donating to dog shelters!'
...
const p_presale_coming_soon = "We are working hard to launch Street Perro. Stay tuned for updates!";
...
const button_presale_mint_whitelisted = "Mint Your Special Perro!";
